...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":6,"pickleLine":86,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":87,"keywordType":"Context","textWithKeyword":"Given User is on login page","stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":88,"keywordType":"Action","textWithKeyword":"When User enters <username> and enter <password>","stepMatchArguments":[]},{"pwStepLine":9,"gherkinStepLine":95,"keywordType":"Action","textWithKeyword":"And User clicks on login button","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":96,"keywordType":"Outcome","textWithKeyword":"Then User is logged in successfully","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":97,"keywordType":"Outcome","textWithKeyword":"And User is able to navigate to product page","stepMatchArguments":[]}]},
]; // bdd-data-end