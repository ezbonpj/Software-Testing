...
test("Top Booked Tests tiles", async ({ page }) => {
  ...
  await page.waitForURL("**/test-listing/top-booked-tests**", { timeout: 15000 });
  ...
  expect(page.url()).toContain("https://www.apollo247.com/test-listing/top-booked-tests");
});